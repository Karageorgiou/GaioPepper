...
public class AutonomousAbilitiesController {
    ...
    public static void buildHolders(QiContext qiContext) {
        AutonomousAbilitiesController.holderAB = HolderBuilder.with(qiContext)
                .withAutonomousAbilities(
                        AutonomousAbilitiesType.AUTONOMOUS_BLINKING)
                .build();
        AutonomousAbilitiesController.holderBM = HolderBuilder.with(qiContext)
                .withAutonomousAbilities(
                        AutonomousAbilitiesType.BACKGROUND_MOVEMENT)
                .build();
        AutonomousAbilitiesController.holderBA = HolderBuilder.with(qiContext)
                .withAutonomousAbilities(
